<nav class="navbar navbar-right navbar-toggleable-md navbar-light bg-faded">
  ...
  <a class="navbar-brand branding-{{$color}}" href="/"><b>&#60;mike/&#62;</b></a>
  <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item {{$page == "Skills" ? 'active': ''}}">
        <a class="nav-link nav-link-{{$color}}" href="/skills">Skills</a>
      </li>
      <li class="nav-item {{$page == "Projects" ? 'active': ''}}">
        <a class="nav-link nav-link-{{$color}}" href="/projects">Projects</a>
      </li>
      <li class="nav-item {{$page == "About" ? 'active': ''}}">
        <a class="nav-link nav-link-{{$color}}" href="/about">About</a>
      </li>
