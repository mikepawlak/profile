...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        App\Requirement::create([
          ...
          'body' => '<p>Barring some very early work, all of my production code has been responsive and mobile compliant. Due to the marketshare of mobile browsers, I have developed a particular interest in mobile design throughout my career.</p>'
        ]);
        App\Requirement::create([
          'id' => '4',
        ...
        App\Requirement::create([
          ...
          'body' => '<p>My previous role was maintaining a web application that had users with IE(8/9), Edge, Chrome, and Safari, coming from desktop, mobile, and tablet devices.'
        ]);
    }
}
